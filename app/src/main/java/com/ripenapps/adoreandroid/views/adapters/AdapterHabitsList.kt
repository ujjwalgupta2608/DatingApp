...
class AdapterHabitsList(list: MutableList<StepSevenEightModel>) :
    RecyclerView.Adapter<AdapterHabitsList.ViewHolder>() {
    private var list = list
    private var selectedPosition = -1
    private lateinit var layoutManager: FlexboxLayoutManager
    private lateinit var optionsAdapter: AdapterHabitOptions

    inner class ViewHolder(binding: AdapterHabitsListBinding) :
