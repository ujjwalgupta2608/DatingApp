...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public static final int BUTTON_WIDTH = /*YOUR_WIDTH_IN_PIXEL_PER_BUTTON*/160;
    ...
    public abstract void instantiateUnderlayButton(RecyclerView.ViewHolder viewHolder, List<UnderlayButton> underlayButtons, Integer position);
    ...
    public static class UnderlayButton {
        ...
        public static Bitmap drawableToBitmap (Drawable drawable) {
            ...
            if(drawable.getIntrinsicWidth() <= 0 || drawable.getIntrinsicHeight() <= 0) {
                ...
                bitmap = Bitmap.createBitmap(drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()-20, Bitmap.Config.ARGB_8888);
            }
